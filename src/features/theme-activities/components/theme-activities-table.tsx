...
import { themeActivitiesColumns as columns } from './theme-activities-columns'

interface ThemeActivitiesTableProps {
  data: ThemeActivity[]
}

export function ThemeActivitiesTable({ data }: ThemeActivitiesTableProps) {
